...
GROUP_ROOM_SCHEMA = {
    "name": "group_room",
    "description": "Read or search current shared Group Chat history, inspect its roster, or reply in your current thread. Identity comes from your admitted turn.",
    "parameters": {"type": "object", "additionalProperties": False,
        "properties": {
            "operation": {"type": "string", "enum": ["members", "history", "search", "send"]},
